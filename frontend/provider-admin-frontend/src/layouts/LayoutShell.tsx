 ...
 * It is the structural base that admin screens mount into.
 */
export function LayoutShell({
  children,
  brandName = "InsureFlow Admin",
  navProps,
  sidebarProps,
  bottomNavProps,
}: LayoutShellProps) {
    ...
    <div className="if-page-shell">
      <header className="if-navbar">
        <div className="if-content-shell if-navbar-inner">
          <div className="if-wordmark">{brandName}</div>
      ...
      {bottomNavProps ? (
        <nav className="if-bottom-nav" aria-label="Mobile navigation">
