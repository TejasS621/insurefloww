import { ArrowRight, CircleDot, ClipboardList, CreditCard, FileStack, ListOrdered, UserRound } from "lucide-react";
...
interface AdminDashboardScreenProps {
  onNavigate: (screen: "dashboard" | "transactions" | "policies" | "payments" | "tickets") => void;
}
...
export function AdminDashboardScreen({ onNavigate }: AdminDashboardScreenProps) {
  ...
  const quickLinks = useMemo(
    () => [
      ...
      { label: "Review Transactions", icon: ListOrdered, screen: "transactions" as const },
      { label: "Review Policies", icon: FileStack, screen: "policies" as const },
      { label: "Review Payments", icon: CreditCard, screen: "payments" as const },
