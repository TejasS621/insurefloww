"""
Provide authentication helpers for the main backend.

Args:
    None: This module defines JWT creation and validation helpers together
    with password hashing utilities for the main backend.

Returns:
    None: Helper functions return signed tokens, decoded claims, or hashed
    password values for use across auth and dependency modules.
