...
from backend.main_backend.app.core.apis.routes._mappers import to_ticket_response
...
from backend.main_backend.app.core.services.ticket_service import ticket_service
