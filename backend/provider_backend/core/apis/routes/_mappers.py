...
from backend.provider_backend.core.models.webhook_retry_model import WebhookRetry
from backend.provider_backend.core.services.provider_sync_service import (
    RetryProcessingResult,
)
from backend.provider_backend.core.services.payment_service import (
...
def to_provider_policy_response(policy: Policy) -> ProviderPolicyResponse:
    ...
    return ProviderPolicyResponse(
        ...
        policy_document_url=f"/api/v1/policies/{policy.policy_number}/document",
    )
